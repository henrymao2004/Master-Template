...
AHA discovers candidate episode mechanisms only with Claude Code / MiniMax.
Episode construction and all evaluation inputs are then frozen before the
benchmark sweep. The remaining five target-agent configurations therefore test
whether misevolution generalizes beyond the agent used for discovery; they are
not used to select or filter episodes.
...
\begin{tabular}{cll}
\toprule
\textbf{ID} & \textbf{Agent framework} & \textbf{Backbone} \\
\midrule
T1 & Claude Code & MiniMax-M2.5 \\
T2 & Codex       & MiniMax-M2.5 \\
T3 & Hermes      & MiniMax-M2.5 \\
T4 & OpenClaw    & MiniMax-M2.5 \\
T5 & Claude Code & Haiku~4.5 \\
T6 & Codex       & GPT-5.4-mini \\
\bottomrule
\end{tabular}
\caption{\textbf{Six target-agent configurations.} T1 is used for AHA
mechanism discovery; the benchmark episodes are frozen before evaluation on
T1--T6. T2--T6 are out of the discovery loop.}
\label{tab:targets}
\end{table}
...
evolution methods. Panel A tests attack amplification, Panel B tests whether
harm survives after the attack disappears, and Panel C checks that the same
methods retain useful learning. This layout makes framework and backbone
...
\textbf{Reflect.} & \textbf{Benign Evo.} & \textbf{SkillRev.} &
\textbf{EvoSkill} & \textbf{SkillClaw} & \textbf{AutoSkill} &
\textbf{SkillsVote} & \textbf{Native} \\
\midrule
\multicolumn{11}{l}{\textbf{A. Attack amplification: $\Delta$ASR (pp; $\downarrow$)}} \\
Claude Code & MiniMax      & 0.0 & -- & -- & -- & -- & -- & -- & -- & N/A \\
Codex       & MiniMax      & 0.0 & -- & -- & -- & -- & -- & -- & -- & N/A \\
Hermes      & MiniMax      & 0.0 & -- & -- & -- & -- & -- & -- & -- & -- \\
OpenClaw    & MiniMax      & 0.0 & -- & -- & -- & -- & -- & -- & -- & N/A \\
Claude Code & Haiku        & 0.0 & -- & -- & -- & -- & -- & -- & -- & N/A \\
Codex       & GPT-5.4-mini & 0.0 & -- & -- & -- & -- & -- & -- & -- & N/A \\
\rowcolor{lightgray}\multicolumn{2}{l}{Macro avg.} & 0.0 & -- & -- & -- & -- & -- & -- & -- & -- \\
\midrule
\multicolumn{11}{l}{\textbf{B. Post-attack behavior: contamination / fresh-session carryover harm (\%; $\downarrow$)}} \\
...
\midrule
\multicolumn{11}{l}{\textbf{C. Capability: benign utility / fresh-session carryover utility (\%; $\uparrow$)}} \\
...
agent and evolution setting. Panel A reports attack-success change relative to
that target's matched no-evolution floor. Panel B reports zero-injection
contamination / clean-session carryover harm. Panel C reports benign utility /
clean-session carryover utility. The four MiniMax rows isolate agent-framework
effects; the paired Claude Code and Codex rows expose backbone effects within a
framework. AHA discovers mechanisms only on Claude Code / MiniMax before the
episodes are frozen; the other five rows are out of the discovery loop. N/A
denotes a genuinely unsupported native method, not a failed run. Artifact
poisoning and the exposure-to-persistence chain are reported in
Table~\ref{tab:chain}. Add 95\% episode-bootstrap intervals in the supplement or
an accompanying interval plot.}
