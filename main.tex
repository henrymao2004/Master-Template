...
evolution methods, and [D] domains, evolved artifacts reach
...
CoEvoSkills, and Hermes-native skill evolution. CoEvoSkills is evaluated as a
general evolution method across all six target-agent configurations.
Hermes-native is tied to the Hermes agent and is evaluated only in the Hermes /
...
\textbf{SkillsVote} & \textbf{CoEvoSkills} & \textbf{Hermes native} \\
\midrule
\multicolumn{11}{l}{\textbf{A. Attack comparison: malicious ASR (\%; $\downarrow$)}} \\
...
\midrule
\multicolumn{11}{l}{\textbf{B. Evolved artifact: content unsafety / unsafe generalization / stealthiness ($\downarrow$)}} \\
...
\midrule
\multicolumn{11}{l}{\textbf{C. Post-attack: carryover harm ($\downarrow$) / carryover utility ($\uparrow$) (\%)}} \\
Claude Code & MiniMax      & --/-- & --/-- & --/-- & --/-- & --/-- & --/-- & --/-- & --/-- & N/A \\
Codex       & MiniMax      & --/-- & --/-- & --/-- & --/-- & --/-- & --/-- & --/-- & --/-- & N/A \\
Hermes      & MiniMax      & --/-- & --/-- & --/-- & --/-- & --/-- & --/-- & --/-- & --/-- & --/-- \\
OpenClaw    & MiniMax      & --/-- & --/-- & --/-- & --/-- & --/-- & --/-- & --/-- & --/-- & N/A \\
...
Provide the original substrate judges and the complete 1--5 rubrics for content
