...
& \textbf{Macro avg.} \\
\midrule
\multicolumn{9}{l}{\textbf{A. Evolution-induced unsafe behavior: $\Delta$Unsafe (pp; $\downarrow$)}} \\
...
\multirow{3}{*}{SkillClaw}
 ...
 & \safeevolve     & -- & -- & -- & -- & -- & -- & -- \\
\midrule
\multicolumn{9}{l}{\textbf{B. Utility gain retained relative to raw evolution (\%; $\uparrow$)}} \\
\multirow{3}{*}{AutoSkill}
 & Raw             & 100 & 100 & 100 & 100 & 100 & 100 & 100 \\
 & Library-Drift   & -- & -- & -- & -- & -- & -- & -- \\
 & \safeevolve     & -- & -- & -- & -- & -- & -- & -- \\
\midrule
\multirow{3}{*}{EvoSkill}
...
Panel A reports paired behavior-level unsafe change relative to each target's
no-evolution floor, combining contamination and carryover harm under the
predeclared primary aggregation. Panel B reports
$(U_{\mathrm{mitigated}}-U_{\mathrm{no\mbox{-}evo}})/
(U_{\mathrm{raw}}-U_{\mathrm{no\mbox{-}evo}})$. Macro averages weight target
agents equally and exclude only genuinely unsupported method--agent pairs.
Report absolute contamination, carryover harm, benign utility, artifact scores,
and overhead in the accompanying breakdown. Bold the safest method whose
