...
supported native learning loops. Each method is evaluated in
...
statistically non-inferior to raw evolution.}
...
Library-Drift, and with \safeevolve on the same four capability benchmarks.
...
& \textbf{SWE-Skills-Bench} & \textbf{MBPP+} & \textbf{Macro avg.} \\
\midrule
\multirow{3}{*}{AutoSkill}
 & Raw             & -- & -- & -- & -- & -- \\
 & Library-Drift   & -- & -- & -- & -- & -- \\
...
\safeevolve on four common skill and coding benchmarks. All values are absolute
